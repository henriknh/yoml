...
class WebSocket(object):
    ...
    # Constructor
    def __init__(self, client, server, reqhandler):
    ...
    def feed(self, data):
        ...
        # We have handshaken
            ...
            logging.info("Data recived: %s", data)
            answer = self.reqhandler.handle_request(data)
            

            # Send our reply
            self.sendMessage(''.join(answer).strip());
    ...
    def dohandshake(self, header, key=None):
        ...
        for line in header.split('\r\n')[1:]:
            ...
            if name.lower() == "sec-websocket-key":
                ...
                # Append the standadatard GUID and get digest
                combined = value + GUID
...
class WebSocketServer(object):
    ...
    # Constructor
    def __init__(self, bind, port, cls, reqhandler):
        self.reqhandler = reqhandler
        ...
        while self.running:
            ...
            for ready in rList:
                if ready == self.socket:
                    ...
                    self.connections[fileno] = self.cls(client, self, self.reqhandler)
                else:
