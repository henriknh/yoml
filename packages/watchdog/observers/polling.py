...
from packages.watchdog.utils import stat as default_stat
from packages.watchdog.utils.dirsnapshot import DirectorySnapshot, DirectorySnapshotDiff
from packages.watchdog.observers.api import (
    EventEmitter,
    BaseObserver,
...
from packages.watchdog.events import (
    DirMovedEvent,
    DirDeletedEvent,
    DirCreatedEvent,
    DirModifiedEvent,
